...
"""
FastAPI application for the Hydropulse Environment.

This module creates an HTTP server that exposes the HydropulseEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m HydroPulse.server.app
    ...
    multiple workers:
        uvicorn HydroPulse.server.app:app --workers 4
    """
    import uvicorn
